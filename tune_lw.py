...
if __name__ == '__main__':
    ...
    vo_motions = np.loadtxt('train_results/'+args.project_name+'/exp_bs=8_lr=1e-6_lw=(0.05,10,10,3)_stereo/1/vo_motion.txt')
    vo_motions = pp.SE3(vo_motions)
    ...
    while epoch <= args.train_epoch:    # this while loops per batch (step)
        ...
        motions = vo_motions[current_idx:current_idx+args.batch_size].cuda()
